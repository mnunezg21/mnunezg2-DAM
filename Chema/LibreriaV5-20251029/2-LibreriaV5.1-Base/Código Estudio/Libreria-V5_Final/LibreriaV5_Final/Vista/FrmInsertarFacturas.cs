    ...
    public partial class FrmInsertarFacturas : Form
    {
        ...
        public FrmInsertarFacturas()
        {
            try
            {
                InitializeComponent();
                LlenarCombos();
                lblCodFactura.Text = UtilFichero.GenerarCodigo(new TFactura().GetType());
            }
            catch (Exception ex)
            {
        ...
        private void LlenarCombos()
        {
            try
            {
                foreach (TCliente cliente in control.BuscarTodo(new TCliente().GetType()))
                {
                ...
                foreach (TLibro libro in control.BuscarTodo(new TLibro().GetType()))
                {
